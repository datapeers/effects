...
export const CARGAR_USUARIO_FAIL = '[Usuario] Cargar Usuario ok';
export const CARGAR_USUARIO_SUCCESS = '[Usuario] Cargar Usuario bad';
...
export type ActionsUser = CargarUsuario | CargarUsuarioFail | CargarUsuarioSuccess;
